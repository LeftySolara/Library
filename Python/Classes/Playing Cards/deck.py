...
DECK_LENGTH = 52    # default number of cards in deck
ACE_HIGH = 11       # value of aces when high
ACE_LOW = 1         # value of aces when low
...
class Deck(object):
    ...
    Attributes:
        ...
        aces_high: If true, every ace has a value of ACE_HIGH. Otherwise, value is ACE_LOW.
    """
    ...
    def sort(self):
        """Sorts cards in the deck in ascending order by rank, then suit"""
        self.cards.sort()
